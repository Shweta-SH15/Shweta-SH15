<h1 align="center"> Welcome to Shweta's Digital Playground!</h1>
...
🔧 Passionate about crafting impactful tech solutions through code, data, and design.  
🎓 Pursuing **Computer Programming** at Sheridan College (Graduating April 2025).  
🌱 Currently learning cloud engineering, data pipelines, and advanced machine learning.  
🎯 Always eager to collaborate, learn, and contribute to meaningful projects and communities.
...
- Used UML design and GitHub for collaborative version control and testing.

---

## 🏆 Hackathons

### 👩‍💻 Hackville – Frontend Developer  
- Built a student-focused app with React, HTML, TypeScript, and Auth0 authentication.  
- Developed swipe UI and login flow, enhancing interactivity and user engagement.

### 🛠️ Sheridan Hackathon – Support Role  
- Assisted participants, answered technical queries, and encouraged teamwork and learning during the event.
...
- **Fundamentals of Azure AI Document Intelligence** – Microsoft Learn

---

<!-- Made with ❤️ by Shweta Patel -->
